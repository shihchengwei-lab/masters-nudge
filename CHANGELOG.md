...
- Replace the retained benchmark with a fresh four-task fixed-order descriptive A/B run: both arms passed 3/4; T03 differed by arm, T04 failed in both arms, and Arm B recorded six injected findings with six later response observations. Treat the result as descriptive and make no effect claim.
